...
<form method="POST" id="admin-form" class="form-horizontal" role="form">
            ...
            <div role="tabpanel" class="tab-pane" id="security">
                ...
                <div class="form-group">
                    <label>
                        ...
                        Use <a href="http://nastyhosts.com" target="_blank">NastyHosts.com</a> - external IP address check service. Please note that claims won't work if NastyHosts is down for some reason.
                    </label>
                </div>
    ...
    compute.amazonaws.com"><:: hostname_ban_list ::></textarea>
                    ...
                    <div class="form-group">
                        <label for="nh_log" class="control-label">NastyHosts 24H Claim Log:</label>
                        <div><:: nh_log ::></div>
                    </div>
                </div>
